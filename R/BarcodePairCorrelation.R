...
#' After running `clusterCorrelatingBarcodes`, inspect the barcode clusters, 
#'  the cluster sizes, and barcode CPM within each cluster.
#'
#' `inspectCorrelatingClusters()` visualize the cluster details generated by 
#'  calling `clusterCorrelatingBarcodes()`.
#' 
#' @param barbieQ A `barbieQ` object created by the [createBarbieQ] function, 
#'  then updated by the [clusterCorrelatingBarcodes] function.
#'
...
#'  group1 = c('Barcode1', 'Barcode2', 'Barcode3'), group2 = c('Barcode4', 'Barcode5')))
#' inspectCorrelatingClusters(barbieQ)
inspectCorrelatingClusters <- function(barbieQ) {
